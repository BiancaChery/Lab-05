...
returns an array where the first element is the product of those numbers, and the second element 
...
to be resourceful to figure out how to do this. However, you may continue to use the + operator for string 
concatenation.
...
where the first element is the sum of the numbers in the array, and the second element is a string that EXACTLY 
...
function that you've already created. You're going to have to be resourceful to figure out how to do this. However, 
...
function sumArray(sumArr) { //eslint-disable-line
    let sum = a + b + c 
    let sumString = `${a},${b},${c} was passed in as an array of numbers, and ${sum} is their sum.`
...
follows this example and concatenates a message using the arguments that were passed into the function:
